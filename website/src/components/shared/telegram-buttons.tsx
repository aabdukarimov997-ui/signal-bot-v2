    ...
    return (
      <div className={cn('flex items-center gap-2', className)}>
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="glass-card flex items-center justify-center size-10 text-gold hover:text-white transition-colors"
  ...
  return (
    <div className={cn('flex flex-wrap items-center gap-3', className)}>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.97 }}
        className="glass-card inline-flex items-center gap-2.5 rounded-xl px-5 py-2.5 text-sm font-medium text-gold hover:text-white transition-colors"
      >
        <Send className="size-4" />
