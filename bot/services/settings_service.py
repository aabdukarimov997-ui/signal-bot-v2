...
SETTINGS_KEYS = {
    ...
    "course_message": "Darslar obuna xabari (to'liq custom matn)",
    "course_description": "Darslar tavsifi",
    "course_image": "Darslar rasmi (Telegram file_id)",
    "course_video": "Darslar video (Telegram file_id)",
    ...
    "signal_message": "VIP Signal obuna xabari",
    "signal_image": "VIP Signal obuna rasmi (Telegram file_id)",
    "signal_video": "VIP Signal obuna video (Telegram file_id)",
